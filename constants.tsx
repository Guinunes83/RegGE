...
export const MOCK_TEAM: TeamMember[] = [
  { 
    id: 't1', active: true, sex: 'M', name: 'Fernando Mendes', role: 'Oncologista', institutionalEmail: 'fernando.mendes@elora.com', 
  ...
  { 
    id: 't2', active: true, sex: 'F', name: 'Camila Sommer', role: 'Coordenador de estudos', institutionalEmail: 'camila.sommer@elora.com', 
  ...
  { 
    id: 't3', active: true, sex: 'M', name: 'Bruno Vivan', role: 'Coordenador de estudos', institutionalEmail: 'bruno.vivan@elora.com', 
