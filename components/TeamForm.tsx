        ...
        <section>
          ...
          {!isView && !isReadOnly && (
            <div className="grid grid-cols-1 md:grid-cols-[1fr,1fr,1fr,1fr,auto] gap-3 mb-4 items-end">
              <input 
                className="border border-gray-300 rounded-md px-3 py-2 bg-white text-sm focus:ring-2 focus:ring-[#007b63] outline-none w-full" 
                placeholder="Nome Plataforma/Site"
          ...
          <div className="overflow-hidden border rounded-lg bg-white shadow-sm">
            <table className="w-full text-left text-sm">
              <thead className="bg-[#007b63] text-white font-semibold">
                <tr>
                  <th className="px-4 py-2">Nome Plataforma / Site</th>
      ...
      {showAddRoleModal && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-sm p-6 relative">
            <h3 className="text-lg font-bold text-[#007b63] mb-4">Adicionar Nova Função</h3>
            <div className="flex flex-col gap-2 mb-6">
              <label className="text-xs uppercase font-bold text-gray-500">Nome da Função</label>
              <input 
                autoFocus
                type="text" 
                className="border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-[#007b63] outline-none w-full"
            ...
            <div className="flex justify-end gap-2">
              <button 
                ...
                className="px-4 py-2 border border-gray-300 text-gray-600 rounded text-sm font-semibold hover:bg-gray-50"
              >
                Cancelar
              </button>
              <button 
                onClick={handleAddCustomRole}
                className="px-4 py-2 bg-[#007b63] text-white rounded text-sm font-bold shadow hover:bg-[#005a48]"
